...
public class CredentialsMatcherRdis extends HashedCredentialsMatcher {
    ...
    public boolean doCredentialsMatch(AuthenticationToken token, AuthenticationInfo info) {
        ...
        String rediFiefx = MessageFormat.format(com.addplus.server.api.constant.StringConstant.REDIS_PREFIX, customizedToken.getLoginType().getType(), customizedToken.getUsername().toUpperCase().hashCode());
