package com.addplus.server.web.shiro.config.consumer;
...
public class RedisContainerConfig {
    ...
    public RedisMessageListenerContainer redisContainer(ThreadPoolTaskScheduler threadPoolTaskExecutor, JedisConnectionFactory getConnectionFactory) {
        ...
        container.addMessageListener(new MessageListenerAdapter(redieMessageQuenueConsumerService()), new ChannelTopic(com.addplus.server.api.constant.StringConstant.REDIS_SHRIO_PERMISSION_TPOIC));
        return container;
    }
}
