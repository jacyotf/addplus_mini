package com.addplus.server.web.shiro.filter;
...
public class AddplusRolesAuthorizationFilter extends RolesAuthorizationFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws IOException {
        ...
        httpServletResponse.setHeader(com.addplus.server.api.constant.StringConstant.ACCESS_CONTROL_ALLOW_CREDENTIALS,"true");
        httpServletResponse.setHeader(com.addplus.server.api.constant.StringConstant.ACCESS_CONTROL_ALLOW_ORIGIN,httpServletRequest.getHeader("Origin"));
