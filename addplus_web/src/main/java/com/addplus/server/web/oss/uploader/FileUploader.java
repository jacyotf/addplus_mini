package com.addplus.server.web.oss.uploader;

import com.addplus.server.api.model.oss.FileResource;
...
public class FileUploader {
    ...
    private String upload(InputStream fileStream, String originalFileName, boolean randomName) {
        ...
        // 获取文件名
        String key = OssFileUtils.getUploadPath(originalFileName, randomName);
        try {
            // 获取uploadId
